...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-green-900 via-emerald-800 to-lime-700 text-emerald-50 w-full shadow-lg sticky top-0 z-[1200] border-b border-green-500/40">
